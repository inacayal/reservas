...
Route::prefix('usuario')->name('usuario.')->group(function (){
    ...
    Route::get('{locales}/{id}','UserController@locales')->where('locales','locales')->name('locales');

    Route::get('{franquicias}/{id}','UserController@franquicias')->where('franquicias','franquicias')->name('franquicias');

    Route::get('/{add}/{id}/{role}','UserController@add')->where('add','add')->name('add');

    Route::get('/{local}/{id}','UserController@singleLocal')->where('local','local')->name('local');

    Route::get('/{franquicia}/{id}','UserController@singleFranquicia')->where('franquicia','franquicia')->name('franquicia');

    Route::delete('/delete/{id}','UserController@delete')->name('delete');

    Route::post('/create','UserController@create')->name('create');

    Route::put('/update/establecimiento','UserController@updateEstablecimiento')->name('update.establecimiento');

    Route::put('/update/usuario','UserController@updateUsuario')->name('update.usuario');

    Route::put('/update/reservas','UserController@updateReservas')->name('update.reservas');
...
Route::prefix('eventos')->name('eventos.')->group(function (){
    ...
    Route::put('/disable','EventoController@disable')->name('disable');
