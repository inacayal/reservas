...
Route::middleware('customauth')->group( function(){
    ...
    Route::prefix('ubicaciones')->name('ubicaciones.')->group( function (){
        ...
        Route::get('/resumen/{type}/{year}','UbicacionController@getYearData')->where('type','anual')->name('resumen.anual');
        Route::get('/resumen/{type}/{month}/{year}','UbicacionController@getMonthData')->where('type','mensual')->name('resumen.mensual');
    ...
    Route::prefix('reservas')->name('reservas.')->group( function (){
        ...
        Route::get('/resumen/{type}/{year}','ReservaController@getYearData')->where('type','anual')->name('resumen.anual');
        Route::get('/resumen/{type}/{month}/{year}','ReservaController@getMonthData')->where('type','mensual')->name('resumen.mensual');
    ...
    Route::prefix('eventos')->name('eventos.')->group( function (){
        ...
        Route::get('/resumen/{type}/{year}','EventoController@getYearData')->where('type','anual')->name('resumen.anual');
        Route::get('/resumen/{type}/{month}/{year}','EventoController@getMonthData')->where('type','mensual')->name('resumen.mensual');
    ...
    Route::prefix('promociones')->name('promociones.')->group( function (){
        ...
        Route::get('/resumen/{type}/{year}','PromocionController@getYearData')->where('type','anual')->name('resumen.anual');
        Route::get('/resumen/{type}/{month}/{year}','PromocionController@getMonthData')->where('type','mensual')->name('resumen.mensual');
    ...
    Route::prefix('horarios')->name('horarios.')->group( function (){
        ...
        Route::get('/resumen/{type}/{year}','HorarioController@getYearData')->where('type','anual')->name('resumen.anual');
        Route::get('/resumen/{type}/{month}/{year}','HorarioController@getMonthData')->where('type','mensual')->name('resumen.mensual');
    ...
    Route::prefix('feriados')->name('feriados.')->group( function (){
        ...
        Route::get('/resumen/{type}/{year}','FeriadoController@getYearData')->where('type','anual')->name('resumen.anual');
        Route::get('/resumen/{type}/{month}/{year}','FeriadoController@getMonthData')->where('type','mensual')->name('resumen.mensual');
