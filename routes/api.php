...
Route::middleware('customauth')->group(
    function(){
        ...
        Route::prefix('administrador')->name('admin.')->group(
            function (){
        ...
        Route::prefix('local')->name('local.')->group(
            function (){
        ...
        Route::prefix('ubicaciones')->name('ubicaciones.')->group(
            function (){
        ...
        Route::prefix('franquicia')->name('franquicia.')->group(
            function (){
        ...
        Route::prefix('reservas')->name('reservas.')->group(
            function (){
        ...
        Route::prefix('eventos')->name('eventos.')->group(
            function (){
        ...
        Route::prefix('promociones')->name('promociones.')->group(
            function (){
        ...
        Route::prefix('horarios')->name('horarios.')->group(
            function (){
        ...
        Route::prefix('feriados')->name('feriados.')->group(
            function (){
